...
public class FileChat {
    /* Tipos de archivos. */
    public static final String TIPO_DOCUMENTO_TEORIA = "DocumentoTeoria";
    public static final String TIPO_PRACTICA_LABORATORIO = "PracticaLaboratorio";
    public static final String TIPO_EJERCICIOS_RESUELTOS = "EjerciciosResueltos";
    ...
    public FileChat(String name, long size, boolean hidden, String tipo) {
        this.name = name;
        this.size = size;
        this.hidden = hidden;
        this.tipo = tipo;
    ...
    public static String generateXMLFromList(ArrayList<FileChat> files) {
        ...
        for (FileChat fileChat : files) {
            ...
            fileXML.addContent(new Element("tipo").setText(fileChat.getTipo()));
    ...
    public static ArrayList<FileChat> generateListFromXML(String xml) {
        ...
        try {
            ...
            for (Element file : filesE) {
                ...
                fileChat.setTipo(file.getChildText("tipo"));
